...
export const gridItems = [
  ...
  },
  {
    ...
    description: "",
    className: "max-md:hidden lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 5,
    title: "passionate about future and hard worker",
    description: "",
...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Taught modern web development end-to-end, drove code quality via structured reviews and CI basics, and supported learners in launching portfolio-grade applications.",
  ...
  },
  {
    ...
    desc: "Lead the DEPI intern front-end team to the final project with creative solutions and select the project's tech stack.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
