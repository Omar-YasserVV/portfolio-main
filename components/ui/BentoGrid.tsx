...
export const BentoGridItem = ({
  ...
  return (
    <div
      ...
      style={{
        // Updated to high-contrast deep black/charcoal
        background: "#020202",
        backgroundColor:
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          lg:opacity-100 rounded-lg text-center bg-[#161616]" // Changed from #10132E
                  >
                    {item}
                  </span>
                ))}
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              >
                ...
                {isClient && copied && <SafeLottie {...lottieProps} />}
              </div>
              ...
              <MagicButton
                ...
                otherClasses="!bg-[#090909]" // Changed from #161A31
              />
            </div>
          )}
        </div>
